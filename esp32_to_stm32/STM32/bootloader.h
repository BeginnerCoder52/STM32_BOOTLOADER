...
/* Memory Layout - STM32F103C8T6 128KB Flash */
...
#define APP_OLD_START       0x0800E000UL       // 56KB offset from current
#define APP_OLD_SIZE        (56UL * 1024UL)    // 56KB
